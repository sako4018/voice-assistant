...
```
py -3.13 jarvis.py --check    # мозък, микрофон, модел, глас — по ред
py -3.13 jarvis.py --hear     # живо: какво чува и колко точки дава на думата
```

`--hear` показва лента със силата на звука и резултата на събуждащата дума.
Кажи "hey jarvis" и гледай: ако лентата не мърда — микрофонът не те чува;
ако мърда, но резултатът стои на 0 — чува те, но не разпознава думата.
И двете може да се пускат, докато Jarvis върви.
